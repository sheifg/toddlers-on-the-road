...
const PackListCard =({packList,handleAdd,openModal,userData}: PackListCardProps) => {
return (
  <div className="container mx-auto mustard font-Mali ">
    <div className="container mx-auto  w-full rounded-lg overflow-hidden shadow-lg text-center bg-mustard bg-opacity-60 lg:gap-x-5">
        <div className="px-6 pt-4 pb-2 lg:pb-0 text-marine-blue">
          <h4 className="font-bold text-xl mb-1 md:text-2xl 2xl:text-3xl">{packList.name}</h4>
        </div>

        <div
        className="container grid grid-cols-1  gap-y-8 mt-4 mb-8 ml-2.5  lg:ml-0.5">
          <ul>
